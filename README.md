...
## Что бы улучшил при дополнительном времени

- добавил визуальные regression-тесты для ключевых desktop, tablet и mobile viewport;
- вынес повторяющиеся motion-паттерны в единую библиотеку transition-токенов;
- добавил стрелочные контролы и более явные подсказки для draggable-лент;
- расширил тестовое покрытие интерактивных состояний и клавиатурной навигации;
- подключил реальные данные для кейсов и отдельный backend для обработки формы обратной связи.
