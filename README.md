...
2. **Дизайн-система, которая работает за вас** (`BrandConsistencySection`) —
   интерактивная лаборатория токенов с вкладками цветов, типографики и компонентов.
...
Новые секции намеренно различаются по композиции: output rail, token lab, workspace, case-study
rail и review board.
